...
public final class SuscripcionPublicacionDomain {
	...
	public SuscripcionPublicacionDomain() {
		super();
	...
	public SuscripcionPublicacionDomain(final UUID identificador, final PerfilDomain perfil, final PlanPublicacionDomain planPublicacion) {
		super();
