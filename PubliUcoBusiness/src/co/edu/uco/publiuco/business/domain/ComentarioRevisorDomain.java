...
public final class ComentarioRevisorDomain {
	...
	public ComentarioRevisorDomain(final UUID identificador, final RevisorRevisionDomain revisorRevision,
			final TipoComentarioRevisorDomain tipoComentarioRevisor, final String comentario) {
		super();
	...
	private final void setRevisorRevision(final RevisorRevisionDomain revisorRevision) {
	...
	private final void setTipoComentarioRevisor(final TipoComentarioRevisorDomain tipoComentarioRevisor) {
