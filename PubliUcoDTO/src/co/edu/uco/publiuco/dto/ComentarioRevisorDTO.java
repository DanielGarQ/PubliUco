...
public final class ComentarioRevisorDTO {
	...
	public ComentarioRevisorDTO(final UUID identificador, final RevisorRevisionDTO revisorRevision,
			final TipoComentarioRevisorDTO tipoComentarioRevisor, final String comentario) {
		super();
	...
	public final ComentarioRevisorDTO setIdentificador(final UUID identificador) {
	...
	public final ComentarioRevisorDTO setRevisorRevision(final RevisorRevisionDTO revisorRevision) {
	...
	public final ComentarioRevisorDTO setTipoComentarioRevisor(final TipoComentarioRevisorDTO tipoComentarioRevisor) {
	...
	public final ComentarioRevisorDTO setComentario(final String comentario) {
