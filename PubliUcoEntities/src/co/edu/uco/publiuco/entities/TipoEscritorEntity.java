...
public final class TipoEscritorEntity {
	...
	public TipoEscritorEntity(final UUID identificador,final String nombre,final String descripcion, final EstadoTipoEscritorEntity estado) {
		super();
	...
	public EstadoTipoEscritorEntity getEstado() {
		return estado;
	}
