...
public class SuscripcionCategoriaEntity {
	...
	public SuscripcionCategoriaEntity(final UUID identificador, final PerfilEntity perfil, final PlanCategoriaEntity planCategoria) {
		super();
	...
	private final void setPlanCategoria(final PlanCategoriaEntity escritor) {
		this.planCategoria = UtilObject.getDefault(escritor, PlanCategoriaEntity.getDefaultObject());
	}
